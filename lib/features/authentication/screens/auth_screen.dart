  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        padding: EdgeInsets.only(left: MQuery.getWidth(context, 24),
            right: MQuery.getWidth(context, 24)),
        child: Column(
          crossAxisAlignment: CrossAxisAlignment.start,
          children: [
            SizedBox(
              height: MQuery.getheight(context, 68),
            ),
            ...
            AuthCustomButton(
                ...
                imagePath: 'assets/images/apple_colored.svg',
            ...
            Row(
              ...
              children: [
                 Text(
                  ...
                  "Dont’t have an account?":"Already have account",
