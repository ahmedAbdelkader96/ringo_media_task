...
class AuthCustomButton extends StatelessWidget {
  const AuthCustomButton(
      {super.key, required this.onPressed, required this.imagePath, required this.title, required this.isLoading});
        ...
        child: Row(
          children: [
            ...
            style: const TextStyle(
              fontSize: 16,fontWeight: FontWeight.w700,color: Color(0xFF191D2B)
            ),)
          ],
        ),
      ));
