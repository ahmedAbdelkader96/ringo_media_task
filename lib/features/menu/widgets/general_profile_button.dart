...
class GeneralProfileButton extends StatelessWidget {
  const GeneralProfileButton({super.key, required this.onPressed, required this.title, required this.child, required this.isLoading});
      ...
      child: Padding(
        ...
        child: Row(
          children: [
            ...
            const Icon(Icons.arrow_forward_ios_outlined,size: 18,color: Colors.black,)
